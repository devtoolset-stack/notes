  ...
  window.OBSIDIAN_DEFAULT_I18N = {
    setting: {
      ...
      editor: {
        ...
        spellcheckLanguagesMacDescription:
        ...
        optionShowInlineTitle: "Show inline title",
        optionShowInlineTitleDescription:
          "Displays the filename as an editable title inline with the file contents.",
        ...
        optionStrictLineBreakDescription:
        ...
        optionPropertiesInDocumentDescription:
        ...
        optionOpenTabInForegroundDescription:
          "When you open a link in a new tab, switch to it immediately.",
        optionDefaultEditingMode: "Default editing mode",
        optionDefaultEditingModeDescription:
        ...
        optionReindexVaultDescription:
          "Rebuilding the cache could take a few seconds to a few minutes depending on the size of your vault.",
        ...
        msgVimModeNotEnabled:
          "Command is incorrect. Vim mode remains disabled to protect you.",
        msgVimModePleaseEnterCommand:
          "Please enter the command to enable Vim mode",
      },
      file: {
        name: "Files and links",
        optionConfirmFileDeletion: "Confirm file deletion",
        optionConfirmFileDeletionDescription: "Prompt before file deletion.",
        optionDeleteDestination: "Deleted files",
        optionDeleteDestinationDescription:
        ...
        optionShowUnsupportedFiles: "Detect all file extensions",
        optionShowUnsupportedFilesDescription:
        ...
        optionAttachmentFolderPathDescription:
        ...
        optionAttachmentSubfolderPathDescription:
      ...
      appearance: {
        ...
        optionMonospaceFontDescription:
          "Set font for places like code blocks and frontmatter.",
        labelSingleFontCurrentlyInEffect: " Currently applied font: ",
        labelMultipleFontsCurrentlyInEffect:
          " The following fonts are currently applied:",
        optionFontPlaceholder: "Enter font name...",
        labelNoCustomFontSet:
        ...
        optionToggleSnippetDescription: "Apply CSS snippet at “{{path}}”.",
        ...
        optionConfigureRibbonDesc:
          "Configure what commands appear in the ribbon menu.",
        optionMobileQuickRibbonItem: "Quick access ribbon item",
        optionMobileQuickRibbonItemDesc:
          "Choose the behavior of tapping the ribbon button in the navigation menu. By default, this will open a menu showing all your ribbon items.",
        optionMobileQuickRibbonDefault: "Open ribbon menu",
        buttonConfigure: "Configure",
        optionShowRibbon: "Show ribbon",
        optionShowRibbonDesc:
        ...
        labelModalConfigurationDesc:
          "Choose what items you want to be active in the ribbon. Drag and drop to change the order.",
        ...
        labelCurrentlyInstalled:
          "You currently have {{count}} theme installed.",
        labelCurrentlyInstalled_plural:
          "You currently have {{count}} themes installed.",
      },
      hotkeys: {
        name: "Hotkeys",
        ...
        optionSearchConflict: "{{count}} command with conflicts.",
        optionSearchConflict_plural: "{{count}} commands with conflicts.",
        promptFilter: "Filter...",
        ...
        tooltipHotkeyMultipleConflicts:
      ...
      integrations: {
        name: "Integrations",
        keychain: "Keychain",
        actionAddPrivateKey: "Add private key",
        actionEditPrivateKey: "Edit private key",
        actionShowPrivateKeyValue: "Show private key",
        actionHidePrivateKeyValue: "Hide private key",
        labelPrivateKeyId: "ID",
        labelPrivateKeyValue: "Private key",
        placeholderPrivateKeyId: "provider-name",
        placeholderPrivateKeyValue: "sk-...",
        optionPrivateKeyIdDescription:
          "Lowercase letters, numbers and dashes only.",
        optionPrivateKeyValueDescription: "Enter your private key.",
        msgErrorUpdatePrivateKey: "Failed to update private key.",
        msgErrorAddPrivateKey: "Failed to add private key.",
        msgErrorPrivateKeyIdExists:
          "A private key with this ID already exists.",
        keychainEmptyState:
          "No private keys have been added. Add a private key to use with integrations.",
      },
      about: {
        name: "General",
        ...
        labelUpToDate: "Obsidian is up to date!",
        labelReadChangelog: "Read the changelog.",
        labelManualUpdateRequired:
        ...
        optionCatalystDesc:
          "You currently have the {{tier}} Catalyst license. Thanks for your support!",
        optionCatalystDescNoLicense:
          "You don't have a Catalyst license. Catalyst is a one-time donation that helps Obsidian remain 100% user-supported and gives you early access to new features.",
        labelApp: "App",
      ...
      account: {
        ...
        optionYourAccountDesc:
          "You're currently signed in as {{name}} ({{email}}).",
        optionYourAccountDescNoLogin:
          "You're not logged in right now. An account is only needed for Obsidian Sync, Obsidian Publish, and early access versions.",
        labelInsider: "Insider",
        labelSupporter: "Supporter",
        labelVip: "VIP",
        ...
        mfaVerificationFailed:
          "2FA code is incorrect, please double check your authenticator app.",
      },
      corePlugin: {
      ...
      thirdPartyPlugin: {
        ...
        optionRestrictedModeDescription:
        ...
        optionBrowseCommunityPluginsDescription:
          "Browse and install community plugins made by our amazing community.",
        buttonBrowse: "Browse",
        labelExitRestrictedMode: "Exit Restricted Mode",
        labelExitRestrictedModeDescription_1:
          "Community plugins, like any other software you install, could potentially cause data integrity and security issues.",
        labelExitRestrictedModeDescription_2:
          "Plugin security is important to us. Here's what we do:",
        labelExitRestrictedModeDescription_3:
          "Despite our efforts, there is still a small chance that a community plugin might misbehave.",
        labelCodeReview: "Initial code review",
        labelCodeReviewDesc:
        ...
        labelReportMechanismDesc:
          "We follow up and remove faulty plugins upon user report.",
        labelExitRestrictedModeDisableConfirmation:
        ...
        msgSuccessfullyInstalledPlugin:
        ...
        labelUninstallPluginConfirmation:
        ...
        optionSearchInstalledPluginDescription:
      ...
      mobileToolbar: {
        ...
        optionConfigureQuickActionDescription:
          "Configure which command to trigger when pulling down from the top. The current command is set to “{{command}}”.",
        ...
        optionAddCommand: "Add global command",
        optionAddCommandDescription:
    ...
    editor: {
      ...
      printModal: {
        ...
        settingPageSizeA3: "A3",
        settingPageSizeA4: "A4",
        settingPageSizeA5: "A5",
        settingPageSizeLegal: "Legal",
        settingPageSizeLetter: "Letter",
        settingPageSizeTabloid: "Tabloid",
    ...
    interface: {
      ...
      switchVault: "Open another vault",
      ...
      promptFilter: "Filter...",
      url: "URL",
      msgCodeblockRenderError:
        "Encountered an error while rendering code block.",
      ...
      msgSandboxVault:
        "This is a sandbox vault.\nChanges you make in this vault will be lost.",
      msgIndexedDbNotSupported:
        "IndexedDB is required for this feature, but it is currently disabled.",
      msgIndexedDbIOS:
        'If you are using iOS in Lockdown Mode, please exclude Obsidian from the "Configure Web Browsing" setting of Lockdown Mode.',
      ...
      emptyState: {
        ...
        unknownPaneDesc:
          "The plugin that created this tab ({{type}}) has gone away.",
      },
      releaseNotes: {
      ...
      startScreen: {
        ...
        optionNewVaultLocationDescription:
        ...
        msgFailedToCreateVaultAtLocation:
        ...
        mobile: {
          labelStartScreen: "Your thoughts are yours.",
          labelSynced: "synced",
          labelNotSynced: "not synced",
          labelNone: "None",
          labelRecommended: "Recommended",
          labelStartScreenDesc:
            "Obsidian stores notes on your device, so you can access them quickly and privately, even offline.\nYour data is stored in a secure local folder called a **vault**.",
          optionCreate: "Create a vault",
          optionUseExisting: "Use my existing vault",
          labelSyncIntro:
            "To access your notes on other devices you need to set up sync.",
          labelSyncIntroDesc:
            "Because Obsidian stores your notes on your devices, you'll need to set up sync if you want to access your notes on another phone or computer.\nYou can set up sync now, or just start writing and set it up later.",
          optionSetupSync: "Setup Sync",
          ...
          labelSyncSetupDesc:
            "Create a synced vault on your Obsidian account so that you can access your data from other devices.",
          labelRemoteVaultCreate: "Sync encryption",
          optionEncryptionCustom: "End-to-end encryption",
          optionEncryptionCustomDesc:
            "Offers the strongest security but requires you to safely store your encryption password",
          optionEncryptionManaged: "Standard encryption",
          optionEncryptionManagedDesc:
            "Uses a key managed by Obsidian to protect your data in transit and on our servers.",
          labelSyncSettings: "Sync Settings",
          labelSyncSettingsDesc:
            "Do you want to exclude any folders or files when syncing to this device?",
          buttonStart: "Start syncing",
          labelSignInOrSignUp: "Create an Obsidian account or sign in",
          ...
          labelRemoteVaultOptionsDesc:
            "Do you want to create a new vault or connect to an existing synced vault?",
          ...
          labelVaultLocationDesc:
            "Your new vault will be placed in {{vaultLocation}}",
          labelRegionSelection: "Region",
          labelRegionSelectionHelp:
            "Choose a server region near you to make syncing faster.",
          labelEncryptionKey: "Encryption key",
          labelEncryptionKeyHelp:
            "This password cannot be changed later. If you forget your password, any remote data on Sync servers will be inaccessible forever.",
          placeholderVaultName: "My vault",
          optRegionSelectionAutomatic: "Automatic",
          labelRemoteVaultSelection: "Choose a vault",
          labelRemoteVaultSelectionDesc:
            "Your account **{{email}}** has existing vaults you can connect to.",
          labelSignIn: "Sign in to your Obsidian account",
          labelForgotPassword: "Forgot password",
          buttonResetPassword: "Reset password",
          msgPasswordReset:
            "We have sent an email to {{email}} to reset your password.",
          labelSyncMethodSelection: "Choose how to sync your notes",
          labelSyncMethodSelectionDesc:
            "To use Obsidian on your devices you will need to sync your data.",
          labelSyncPro1: "Seamless across every device and OS.",
          labelSyncPro2:
            "Secured with the strongest end-to-end encryption standard.",
          ...
          labelObsidianSync: "Obsidian Sync",
          labelIcloud: "iCloud",
          labelOther: "Other",
          ...
          labelEmailEntryDesc:
            "Your email is required to create an Obsidian account.",
          labelSignup: "Enter your name and password",
          emailVerification: "Connect to Obsidian Sync",
          emailVerificationDesc:
            "You should receive an email shortly to **{{email}}** with instructions to connect to Obsidian Sync.",
          icloudMissing: "iCloud",
          icloudMissingDesc:
            "Your iCloud vault was not detected. This could be due to any of the following reasons:",
          icloudMissingReason1:
            "Your vault is on a different iCloud account than the one you are currently signed into on this device.",
          icloudMissingReason2:
            "Your vault is not stored on the top-level Obsidian folder of your iCloud Drive.",
          iCloudUnsupported: "iCloud not supported",
          iCloudUnsupportedDesc:
            "iCloud syncing is only available on Apple devices. If your vault is currently syncing via iCloud, learn how to migrate your vault to a different sync service.",
      ...
      mobile: {
        ...
        feedback: {
          ...
          labelFeedbackDesc:
            "Are you enjoying Obsidian? Help us by giving it a rating.",
        ...
        debug: {
          ...
          disableTheme: "Disable theme and snippets",
        },
      },
      helpScreen: {
        labelOfficialHelpSite: "Official help site",
        labelOfficialHelpSiteDesc:
          "Read the official help documentation of Obsidian, available in multiple languages.",
        actionVisit: "Visit",
        labelDiscordChat: "Discord chat",
        labelDiscordChatDesc:
          "Discord is the best place to chat with other experienced Obsidian users from around the world.",
        actionJoin: "Join",
        labelForum: "Official forum",
        labelForumDesc:
          "Help each other, post feature requests, report bugs, and have in-depth discussions about knowledge management.",
        labelSandboxVault: "Sandbox vault",
        labelSandboxVaultDesc:
          "Play around and experiment with various features. Please note your changes will not be saved.",
      },
    },
    commands: {
    ...
    dialogue: {
      ...
      labelDeleteFolderWarning:
        "If you continue, all files inside this folder will be deleted.",
      labelDeleteFolder: "Delete folder",
      buttonDelete: "Delete",
      buttonDeleteDoNotAskAgain: "Delete and don't ask again",
      labelDoNotAskAgain: "Don't ask again",
      labelExistingBacklink:
        "There is currently {{count}} link pointing to this note.",
      labelExistingBacklink_plural:
        "There are currently {{count}} links pointing to this note.",
      ...
      msgBlockIdInvalid:
        "Block ID can only contain alphanumeric characters or dash",
    ...
    plugins: {
      ...
      fileExplorer: {
        ...
        actionNewFolderWithCount_plural:
          "New folder with selection ({{count}} items)",
        ...
        tooltipFoldersFilesCount: "{{fileCount}}, {{folderCount}}",
        labelUntitledFile: "Untitled",
        labelUntitledFolder: "Untitled",
        msgSetAttachmentFolder:
      ...
      quickSwitcher: {
        ...
        optionShowExistingOnlyDescription:
      ...
      graphView: {
        ...
        tooltipClickToChangeDragToReorder:
      ...
      properties: {
        ...
        labelSortByFrequencyHighToLow: "Frequency (high to low)",
        labelSortByFrequencyLowToHigh: "Frequency (low to high)",
        msgMergePropertiesWarning:
          "Merge property “{{oldKey}}” with “{{newKey}}”?",
        msgMergePropertiesWarningDesc:
          "In case of conflicts, the values will be merged or the value from “{{oldKey}}” will be used.",
        actionCollapseAll: "Collapse all",
        actionExpandAll: "Expand all",
      ...
      commandPalette: {
        ...
        promptTypeCommand: "Select a command...",
        labelPinnedCommands: "Pinned commands",
        optionAddNewPin: "New pinned command",
        optionAddNewPinDescription:
      ...
      dailyNotes: {
        ...
        optionNewFileLocationDescription:
        ...
        optionOpenOnStart: "Open daily note on startup",
        optionOpenOnStartDescription:
      ...
      uniqueNoteCreator: {
        ...
        msgFolderNotFound:
          "Failed to create unique note. Folder “{{folderOption}}” not found.",
        ...
        msgTemplateFileNotFound:
          "Failed to create unique note. Template file “{{template}}” not found.",
        msgFailedToGenerate:
          "Failed to generate a unique note with the format “{{format}}”",
      },
      randomNote: {
        name: "Random note",
      ...
      templates: {
        ...
        msgFailInvalidFolder:
          "Failed to list templates. Template folder is invalid.",
        msgFailFolderNotFound:
          "Failed to list templates. Folder “{{folderOption}}” not found.",
        msgFailInvalidTemplateProperties:
          "Unable to insert template, the properties in the template file could not be read.",
        msgNoFolderSet:
      ...
      publish: {
        ...
        labelNoInternetAccess:
          "You need access to the internet to publish changes.",
        labelPublishServiceDescription:
        ...
        labelDeleteSiteConfirmation:
          "Are you sure you want to delete this site?",
        labelDeleteSiteDetails:
        ...
        optionCustomizeNavigationDesc:
          "Override the order of navigation items and hide pages or folders from showing.",
        optionNavigationOrder: "Navigation item display order",
        optionHideItemsInNavigation: "Hide pages or folders from navigation",
        optionHideItemsInNavigationDesc:
          "Right click and select “Hide” to prevent specific pages from appearing in the site navigation. The pages will still be accessible via links or accessing the URL directly.",
        optionShowHiddenItems: "Show hidden",
        buttonCustomizeSidebar: "Manage",
        labelNavigationModalTitle: "Navigation",
        labelNavigationModalDesc:
          "Drag and drop to customize the order in which navigation items appear on your Publish site.",
        ...
        optionShowThemeToggleDescription:
          "Let visitors toggle between light and dark theme on their own.",
        optionShowNavigation: "Show navigation",
        optionShowNavigationDescription:
          "Display a list of all published pages on the left side of your published site.",
        optionShowSearch: "Show search bar",
        optionShowSearchDescription:
        ...
        msgNoPermissionToPublishToSite:
        ...
        labelSharingWithUsers:
          "This site is currently shared with the following people:",
        ...
        msgEnablePublishPlugin:
          "Please enable the Publish core plugin in Settings -> Core plugins to view sites.",
        ...
        labelLeaveSiteConfirmationDetails:
          "This will remove this site from the list of sites shared with you. This action cannot be reverted.",
        labelLeaveSiteConfirmationDetails_2:
          "Please contact the owner of the site if you wish to collaborate on this site again.",
        buttonLeave: "Leave",
        ...
        labelConfirmOverride_1:
          "Are you sure you want to override the local version?",
        labelConfirmOverride_2:
          "The live version will be used and your local version will be discarded. Please make backups if necessary.",
        buttonProceed: "Proceed",
        messageSuccessfullyUsedLiveVersion:
          "Successfully used live version to override your local version.",
        ...
        optionIncludedFoldersDesc:
          "Files under these folders will automatically be selected when you review changes to publish.",
        optionCurrentlyIncludedFolders:
          " These folders are currently included:",
        optionExcludedFolders: "Excluded folders",
        optionExcludedFoldersDesc:
          "Files under these folders won't show up when you review changes to publish. This setting takes priority over included folders above.",
        labelNumberOfFoldersIncluded:
          "Obsidian Publish is currently including {{folders}}.",
        labelNumberOfFoldersExcluded:
          "Obsidian Publish is currently excluding {{folders}}.",
        ...
        labelAddIncludedFolderDesc:
          "You can include both existing folders and folders that have not been created yet.",
      ...
      sync: {
        ...
        msgSuccessfullyCreatedVault:
          "Successfully created remote vault “{{name}}”.",
        labelRemoteVaultExplanation:
        ...
        optionVaultRegionDesc:
          "Select the server region closest to you to store the remote vault. This cannot be changed in the future.",
        optionVaultNamePlaceholder: "My awesome vault",
        optionEncryption: "Encryption",
        optionEncryptionDesc:
          "End-to-end encryption offers the strongest security but requires you to safely store your encryption password. Standard encryption uses a key managed by Obsidian to protect your data in transit and on our servers.",
        ...
        optionEncryptionPasswordDescWarning:
        ...
        labelEncryptionPasswordExplanation:
          "The remote vault “{{name}}” is currently encrypted. Enter your password to unlock.",
        ...
        labelConfirmDeleteRemoteVaultQuestion:
          'Are you sure you want to delete the remote vault "{{name}}"?',
        labelConfirmDeleteRemoteVaultResult:
          "All data on our server, including version history, will be deleted. Your local files will stay intact.",
        labelConfirmDeleteRemoteVaultWarning:
          "This action is permanent and irreversible.",
        msgRemoteVaultDeleted: "{{name}} has been deleted.",
        msgDisconnectFromDeletedVault:
          "Obsidian Sync: The connected remote vault no longer exists.",
        ...
        labelNoSubscription:
          "You don't have an active Obsidian Sync subscription.",
        ...
        labelThirdPartySyncWarningDesc:
          "Warning: Your vault seems to be using {{service}} as a third party sync service. If you use Obsidian Sync with this vault, you may run into conflicts, file corruption, or data loss.",
        labelIcloudDriveWarning:
          "If you are using iCloud Drive, your Documents and Desktop folders might be synced by iCloud. This could cause conflicts with Obsidian Sync.",
        optionRemoteVault: "Remote vault",
        buttonChooseRemoteVault: "Choose",
        buttonManageRemoteVault: "Manage",
        optionRemoteVaultDescConnected:
          "Currently connected to the “{{name}}” remote vault.",
        optionRemoteVaultDescNotConnected:
        ...
        optionDeviceNameDesc:
          "This name will be displayed in the activity log. Leave empty to use the default name.",
        buttonResume: "Resume",
        buttonPause: "Pause",
        ...
        optionPreventSleepDesc:
          "Prevents the device from going to sleep when there are still files to be synced.",
        optionSelectiveSync: "Selective sync",
        optionExcludedFolders: "Excluded folders",
        optionExcludedFolderDesc: "Prevent certain folders from being synced.",
        optionCurrentlyExcludedFolders:
          " These folders are currently excluded:",
        ...
        labelManageExcludedFolders: "Manage excluded folders",
        labelNumberOfFoldersExcluded:
          "Obsidian Sync is currently excluding {{folders}}.",
        labelAddExcludedFolder: "Exclude a folder",
        labelAddExcludedFolderDesc:
          "You can exclude both existing folders and folders that have not been created yet.",
        ...
        msgVaultMergeWarning:
          "If you connect to the remote vault “{{name}}”, notes in your local vault will be merged with notes from your remote vault. In case of conflicts, the most recent version of the note will be preserved.",
        tooltipUpdateSettingOnAllDevices:
          "Please update this option and restart app on all the devices where you want it to take effect.",
        labelSharingWithUsers:
          "This remote vault is currently shared with the following people:",
        labelNotSharing:
          "This remote vault is not currently shared with anyone.",
        ...
        labelLeaveVaultConfirmationDetails:
          "This will remove this vault from the list of vaults shared with you. This action cannot be reverted.",
        labelLeaveVaultConfirmationDetails_2:
          "Please contact the owner of the vault if you wish to collaborate on this vault again.",
        buttonLeave: "Leave",
        msgErrorFailedToFetch: "Failed to load remote vaults.",
        labelRequireSubscriptionToConnect:
          "You need an Obsidian Sync subscription to connect to this vault.",
        optionContactSupport: "Contact support",
        optionContactSupportDesc:
          "If you run into any issues with Obsidian Sync, please contact us so we can help you out! You can reach us at support@obsidian.md.",
        ...
        msgRemoteVaultLimitHit:
          "You have created the maximum number of remote vaults. In order to create a new remote vault, please upgrade your account or remove an existing one.",
        labelUpgradeVault: "Upgrade vault",
        labelUpgradeVaultEncryption: "Upgrade vault encryption",
        labelUpgradeVaultEncryptionDesc:
          "There is a new encryption version available for remote vaults.",
        ...
        msgRecreateRemoteVault:
          "This will delete your remote vault and recreate it with the latest encryption. Local files will not be affected, however your version history will be lost.",
        labelConfirmMigrate: "Confirm vault migration",
        msgMigratePreConfirmationPart1:
          "To upgrade your encryption, all data in the vault will be re-uploaded to the Obsidian Sync servers using the new encryption method. This process will permanently delete all data encrypted with the old encryption, including the version history for your vault.",
        msgMigratePreConfirmationPart2:
          "Important: we strongly recommend creating a backup of your vault before proceeding to prevent any potential data loss.",
        msgMigratePreConfirmationPart3:
          "After completing the upgrade, you will need to reconnect all your devices to the updated remote vault.",
        msgMigrateConfirmation:
          "Migrating your vault may take some time. You will need to keep Obsidian active on this device to re-upload all your notes and attachments. It is best to do this on your primary device.",
        msgMigrateConfirmationSize:
          "You have {{size}} of data. Migrating your vault may take some time. You will need to keep Obsidian active on this device to re-upload all your notes and attachments. It is best to do this on your primary device.",
        ...
        labelResolveConflictsDesc:
          "Choose how conflicts are resolved when a note is independently modified on multiple devices.",
      ...
      fileRecovery: {
        ...
        labelClearWarning:
          "Are you sure you want to delete all snapshots? Files inside your vault will not be affected.",
      ...
      noteComposer: {
        ...
        optionSplitReplacementTextDescription:
      ...
      webViewer: {
        ...
        actionClearDataAllDesc:
          "Removes all of the above as well as local storage and active sessions.",
      ...
      canvas: {
        ...
        labelExportPngDesc:
          "Export “{{title}}” as a PNG file with the settings below.",
        ...
        msgUpdatingLinks:
          "Canvas detected file renames affecting {{count}} canvas file, updating...",
        msgUpdatingLinks_plural:
          "Canvas detected file renames affecting {{count}} canvas files, updating...",
      ...
      bases: {
        ...
        msgFilterSimpleUnavailable:
          "This filter cannot be represented by the simple filter builder.",
        msgFilterCannotParse:
          "Filter cannot be parsed. Basic filter builder cannot be used.",
        msgErrorInvalidPropertiesSection: "Invalid properties configuration.",
        msgErrorInvalidPropertyConfig:
          'Invalid property config for "{{ name }}".',
        msgErrorRegisterView:
          'Unable to add new Bases view "{{ viewId }}". A view with this ID already exists.',
        msgErrorUnableToParse: "Unable to parse your base file:",
        msgErrorViewNotFound: 'View "{{ view }}" not found',
        msgErrorUnknownViewType:
          "Base configured with an unknown view type: {{ viewtype }}",
        msgErrorViewType: "Views must be an array",
        msgErrorDisplayValues:
          "Display values must be strings. Value for property {{ key }} is not.",
        msgErrorMustBeAType: '"{{ key }}" must be a {{ type }}',
        msgErrorFilterType: '"filters" must be a string or an object',
        msgErrorFilterMustBeArray:
          '"{{ conjunction }}" filter must be an array',
        msgErrorFilterAllowedKeys:
          '"filters" may only have one of an "and", "or", or "not" keys.',
        msgErrorFilterFailedToEvaluate:
          "Failed to evaluate a filter: {{ message }}",
        msgErrorFormulaValues:
          "Formula values must be strings. Value for property {{ key }} is not.",
        msgErrorComputedFailedToCompute:
          'Failed to compute value of property "{{ key }}": {{ message }}',
        msgErrorInvalidQueryFormat:
          "Query is an invalid format. It should be a YAML object.",
        msgErrorViewInvalidFormat:
          '"view" items must be a YAML object, however item {{ index }} is not',
        msgErrorViewNameInvalid:
          'Missing or invalid "name" in view {{ index }}',
        msgErrorViewMissingRequiredKey:
          '"{{ key }}" is required in view "{{ viewName }}"',
        msgErrorViewIncorrectType:
          '"{{ key }}" must be a {{ type }} in view "{{ viewName }}"',
        msgErrorViewIncorrectValueType:
          '"{{ key }}" values must all be of type {{ type }} in view "{{ viewName }}"',
        msgErrorViewParsingFilters:
          'Unable to parse filters in view "{{ viewName }}": {{ message }}',
    ...
    formulas: {
      ...
      msgErrorInvalidInstanceFunction:
        'Cannot find function "{{ function }}" on type {{ type }}',
      msgErrorNotEnoughArguments:
        'Cannot call function "{{ function }}", not enough arguments.',
      msgErrorTooManyArguments:
        'Cannot call function "{{ function }}", too many arguments.',
      msgErrorTypeError:
        'Type error in "{{ function }}", parameter "{{ parameter }}". Expected {{ expected }}, given {{ given }}.',
      msgErrorInvalidArrayAccess:
        'Cannot access index "{{ index }}" of non-array value',
      msgErrorInvalidObjectAccess:
        'Cannot find "{{ index }}" on type {{ type }}',
      funcs: {
        labelGlobalNow:
          "Returns a date object representing the current moment.",
        labelGlobalToday:
          "Returns a date object representing the current date. The time portion is set to zero.",
        labelGlobalDate:
        ...
        labelGlobalList:
          "Wrap the provided `element` in a list, creating a list with a single element. If the `element` is a list, return it unmodified.",
        labelGlobalLink:
        ...
        labelStringReplace:
          "Returns a string with occurrences of `pattern` replaced with the `replacement`.",
        labelStringLower: "Returns the string converted to lower case.",
        labelStringSplit:
          "Returns an list of `n` substrings by splitting on `separator`.",
        labelStringContains: "Returns true if the string contains `value`.",
        labelStringContainsAny:
          "Returns true if the string contains at least one of the `values`.",
        labelStringContainsAll:
          "Returns true if the string contains all of the `values`.",
        labelStringSlice:
          "Returns a substring from `start` (inclusive) to `end` (exclusive).",
        labelStringRepeat:
          "Returns a string that is constructed from repeating this string the specified times.",
        ...
        labelObjectMap:
          "Transform each key value pair of this object into a list by calling a conversion function, which uses the variables `key` and `value`, and returns the new value to be placed in the list.",
        labelObjectFilter:
          "Filter the elements of this object by calling a filter function, which uses the variables `key` and `value`, and returns a boolean value for whether the element should be kept.",
        labelRegExpMatches:
    ...
    properties: {
      ...
      labelChangePropertyTypeDesc:
        "Your {{oldType}} data is not compatible. It will be adapted to fit the new format.",
    },
    table: {
      labelColumn: "Column",
      labelRow: "Row",
